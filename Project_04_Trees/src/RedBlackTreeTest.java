...
public class RedBlackTreeTest
{
  ...
  @Test
  public void testGetLinear() // ONLY CAN OBTAIN 9
  {
    setUpLinear();
    Assert.assertEquals("One", tree.get(1));
  ...
  @Test
  public void testToStringLinear() // ONLY DISPLAYS 9
  {
    setUpLinear();
  ...
  @Test
  public void testHeightLinear() // 9 IS THE ONLY THING LEFT LEADING TO A HEIGHT OF 0
  {
    setUpLinear();
    Assert.assertEquals(3,tree.getHeight());
  }
